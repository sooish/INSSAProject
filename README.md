...
- 서비스를 제공하기 위해 웹페이지를 구현한다. 특별히 index.html에는 우리가 제공하는 주요한 장소정보를 워드클라우드로 시각화한다.
